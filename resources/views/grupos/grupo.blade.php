                                                            ...
                                                            <div class="modal-body">
                                                                <center>
                                                                    <form action="{{ route('grupo.actualizar') }}"
                                                                        ...
                                                                        <button type="submit" id="btnedit-{{  $grupo['COD_GRUPO']   }}"
                                        ...
                                        <form action="{{ route('grupo.insertar') }}" method="post">
                                            ...
                                            <label class="form-label">
                                                ...
                                                <label class="form-label">
                                                    ...
                                                    <input type='number' name='grupo' min="0" id="ins_num_grupo"
                                                ...
                                                <br>
                                                <button type="submit" onclick="verificarData();" id="btninsertar" class="btn btn-primary">Registrar </button>
                                        </form>
                                </div>
...
@section('js')
    ...
    <script>
        ...
        function verificarData() {
            ...
            let ins_um_grupo = document.getElementById('ins_num_grupo').value 
