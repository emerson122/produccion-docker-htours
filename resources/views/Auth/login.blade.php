...
<body>
@if (Session::has('errorsinPersonas'))

<script>
    Swal.fire({
        icon:'error',
        text:'Hubo un problema con el registro del usuario.Informa al administrador que se debe Asegúrar de que el usuario no esté ACTIVO si es un usuario NUEVO.'
    })
    </script>    
@endif
