                        ...
                        <div class="modal-container">
                          ...
                          <label class="form-label">
                            ...
                            <input 
                              type='text' 
                              name='PREGUNTA'
                              id="preguntaEdit-{{ $preg['COD_PREG'] }}"
                              onkeyup="validarPreg({{  $preg['COD_PREG'] }})"
                              size="50" maxlength="100" 
                              class="form-control text-white"
                              value="{{$preg['PREGUNTA']}}"  
                              required>
                              <center>
                                <div style="background-color: white; opacity: 0.5;" id="divpregedit-{{  $preg['COD_PREG'] }}"></div>
                              </center>
                          </label>
                          <br>
                          <label class="form-label">
                            ...
                            <input 
                              type='text' 
                              name='RESPUESTA'
                              id="respuestaedit-{{ $preg['COD_PREG'] }}"
                              onkeyup="validarRes({{  $preg['COD_PREG'] }})"
                              size="50" maxlength="100" 
                              class="form-control text-white"
                              value=""  
                              required>
                              <center>
                                <div style="background-color: white; opacity: 0.5;" id="divcres-{{  $preg['COD_PREG'] }}"></div>
                              </center>
                            </label>
                          <label class="form-label">
                          </label>
                          ...
                          <button type="submit" id="btnedit-{{$preg['COD_PREG']  }}" class="btn btn-primary">Aceptar</button>
                          </form>
                          </div> 
