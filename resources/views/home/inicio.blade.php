...
@if (!Cache::has('genero'))
  {{ header('Refresh: 10; url='.route("Auth.login")) }}
  <p class="alert alert-danger agileits" role="alert">Hubo un problema con el registro de usuario. Asegúrate de que el usuario no esté activo si es nuevo y contacta a un administrador.</p>
@endif
