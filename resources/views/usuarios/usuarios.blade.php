...
@section('contenido')
    ...
    @endif
    @if (Session::has('correodup'))
        <script>
            Swal.fire({
                icon: 'error',
                text: 'El correo no se puede registrar'
                // footer: '<a href="">Why do I have this issue?</a>'
            })
        </script>
    @endif
    @if (Session::has('userdup'))
        <script>
            Swal.fire({
                icon: 'error',
                    ...
                    <div class="modal fade bd-example-modal-lg" id="dialogo1">
                        ...
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <center>
                                        <form action="{{ route('usuario.insertarinterno') }}"
                                        method="post">
                                        @csrf 
                                       
                                        <label class="form-label">
                                            Usuario
                                            <input type='text' style="text-transform:uppercase" onkeyup="javascript:this.value=this.value.toUpperCase(); validarletrasUSR(this);"  id="userIns" name='USUARIO'
                                                class="form-control text-white"
                                                maxlength="50"
                                                onkeyup=""
                                                value=""
                                                required>
                                                <center>
                                                    <div style="background-color: white; opacity: 0.5;" id="divinsuser"></div>
                                                </center>
                                        </label>
                                        <label class="form-label">
                                            Nombre del usuario
                                            <input type='text' name='NOMBRE_USUARIO'
                                                class="form-control text-white"
                                                id="NOMBRE_USUARIO" maxlength="100"
                                                onkeyup="validarletrasdeNomiNS(this)" 
                                                value=""
                                                required>
                                                <center>
                                                    <div style="background-color: white; opacity: 0.5;" id="divusrnomusuarioINS"></div>
                                                </center>
                                        </label>
                                        <label class="form-label">
                                            Contraseña
                                        ...
                                        <label class="form-label">
                                            ...
                                            <input type='password' name='repetir'
                                                class="form-control text-white"
                                                id="password-2" maxlength="100"
                                                onkeyup="validarcontrajenas(this.value)"
                                                value=""
                                                required>
                                                <center>
                                                    <div style="background-color: white; opacity: 0.5;" id="divusrusuario"></div>
                                                    <div  id="error-contrasenas"></div>
                                                </center>
                                        </label>
                                        ...
                                        <a href=""
                                            class="btn btn-secondary">Cancelar</a>
                                        <button type="submit" id="btninsertar" onclick="validarcamposvacios();"
                                            class="btn btn-primary">Aceptar</button>
                                    </form>
                                </div>
