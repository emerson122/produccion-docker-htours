...
class SessionController extends Controller
{
    ...
    */
    ...
    public function home()
    {
        ...
        Session::flash('errorsinPersonas', 'Hubo un problema con el registro de usuario. Asegúrate de que el usuario no esté activo si es nuevo y contacta a un administrador.');
    ...
    */
    ...
    /**
     * Metodo para refrescar el token y obtener uno nuevo
     */
