...
function validarnumeros(e) {
    ...
    let btn = document.getElementById('btninsertar2');
...
function validarletras(e) {
    ...
    let btn = document.getElementById('btninsertar2');
    if (expresiones.especiales.test(cuentas)) {
        ...
        div.innerHTML='<font color="red"> <h5>Solo puedes ingresar letras y numeros, menores a 16 caracteres</h5></font>'
...
function validarNgrupos(e) {
    let numgrupo = document.getElementById('ins_num_grupo').value;
    let div = document.getElementById('div_num');
    let btn = document.getElementById('btninsertar');
    // console.log(cuentas);
    if (expresiones.numeros.test(numgrupo)) {
        document.getElementById('ins_num_grupo').classList.remove('incorrecto') 
        document.getElementById('ins_num_grupo').classList.add('correcto') 
        console.log('correcto');
        div.innerHTML='';
        btn.disabled = false;
    }else{
        document.getElementById('ins_num_grupo').classList.add('incorrecto')
        div.innerHTML='<font color="red"> <h5>Solo puedes ingresar numeros</h5></font>'
        console.log('incorrecto');
        btn.disabled = true;
    }
...
function validarLgrupos(e) {
    let nom_grupo = document.getElementById('ins_nom_grupo').value;
    let div = document.getElementById('divgrupo');
    
    let btn = document.getElementById('btninsertar');

    if (expresiones.especiales2.test(nom_grupo)) {
        document.getElementById('ins_nom_grupo').classList.remove('incorrecto') 
        document.getElementById('ins_nom_grupo').classList.add('correcto') 
 
        div.innerHTML='';
        console.log('correcto');
        btn.disabled = false;
    }else{
        document.getElementById('ins_nom_grupo').classList.add('incorrecto') 
      
        div.innerHTML='<font color="red"> <h5>Solo puedes ingresar letras y numeros, no caracteres</h5></font>'
